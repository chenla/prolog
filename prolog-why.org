...
[fn:4] Despite common belief, Tang, [[https://en.wikipedia.org/wiki/Polytetrafluoroethylene][Teflon]], and [[https://en.wikipedia.org/wiki/Writing_in_space][The Fisher
Space Pen]] were not invented for specifically for NASA:
...
[fn:3] The Soviets had solved the pen problem decades before
with the invention of the pencil.
