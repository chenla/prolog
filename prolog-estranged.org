...
right, but got the dates wrong.  The beat and black mountain
folks were the faintest of hairline cracks in modernism,
that grew into the counter-cultural movement in the 1960's
and 1970's which still have a very long way to go.  So
perhaps it's better to say that Olson saw the beginning of
the beginning of an end that we still can't see.  We are so
broken, that we have forgotten what the world is, or how we
once were part of it and are only now waking up to the
reality of how much damage our estrangement has resulted in.
