...
data structures, they are how we take information and turn
them into data structures.  In that sense the schemes we use
to structure things go hand in hand with the data structures
...
organizes it's information is a mirror of the way that power
is organized within that organization.
...
provide enough background and context to unserstand the
