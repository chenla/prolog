...
*** TOC I
  ...
  - Turing Unversal Machine -- no distinction between
...
The Arc of Nong Pao would be one:


   - a scopic arc in Laos
   - a network of villages in NE Cambodia
   - a major city in a bioregion
   - a moon base
   - a village on mars
   - a 'bioregion' on mars (perhaps built in the trench)
   - O'Neil Cylinder
