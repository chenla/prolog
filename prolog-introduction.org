...
Okay, /The Yellow Brick Road/ prepares you for the journey and starts
you down the road.
...
But the /Nature of Things/ still hasn't gelled.  In a sense it's going
on to cover everything that the quadrivium didn't.  But since these
are lifetime study plans, perhaps that's what should be put into the
work -- so the base physics and even philosophy that I have now in NOT
could be put into the quadrivium, and then the scenarios that we need
to consider before planning the library of last resort are actually
the first part of LOLR, since having completed the quadrivium, the
reader will have a good grasp of cosmology, physics, evolution,
extinction events, climate change and planetary biological systems.
